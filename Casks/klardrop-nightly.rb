...
# renders 1.0.0-nightly.754 (full pre-release semver, so `brew upgrade` sees each new build),
# 0cc925222bb03890ecc058ec3379f0e8905af43b878e42e1c61005435528c716 (the published DMG's checksum) and klardrop-1.0.0.dmg (the version-stamped DMG filename),
...
cask "klardrop-nightly" do
  version "1.0.0-nightly.754"
  sha256 "0cc925222bb03890ecc058ec3379f0e8905af43b878e42e1c61005435528c716"
